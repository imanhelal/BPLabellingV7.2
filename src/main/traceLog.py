...
class TraceLog:
    ...
    def prepare_traceLog(self,i=0):
        if(i==0):
            i=self.identifier
        print i , 'confidence level :',self.__confidenceLevel
        print ''.join(str(str(i.caseId)+':'+i.timestamp+":"+i.activity+" ") for i in self.__events)
        #print events
        print '----------------------------'
    ...
    def write_traceLog_into_file_txt(self,i=0,directory="labeledEventLog_txt/"):
        ...
        name=''.join(str(str(i)+" - CL- "+str(self.confidenceLevel)))
    ...
    def write_traceLog_into_file_csv(self,i=0,directory="labeledEventLog_csv/"):
        ...
        for e in events:
            data.append(str(e.caseId)+';'+e.timestamp+";"+e.activity)
        #print events
        #print '----------------------------'
